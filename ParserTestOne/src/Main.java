...
ПРОБЛЕМЫ: в терминале ебучие кракозябры вместо русского из программы (русский спарсенный с сайта нормально отображается)
 */
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        try{// пробуем получить страницу сайта
            ...
            document = Jsoup.connect("https://easyoffer.ru/rating/android_developer")//ЦЕЛЕВОЙ САЙТ
                    .userAgent("Chrome/4.0.249.0 Safari/532.5").referrer("http://www.google.com") //притворяемся браузером
                    .get();
        ...
        //document.select("td").forEach(System.out::println); //быстро вывести в терминал с разметкой
        ...
        for (Element element : document.select("td")){ //выдергивает и печатает в терминал каждую ячейку
            System.out.println(element.text()); //выводим в терминал спарсенные с сайта ячейки
        } //конец for


/* есть идея, но не доделано
